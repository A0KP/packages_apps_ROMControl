...
public class ButtonSettingsFragment extends Fragment {
    ...
    public static class SettingsPreferenceFragment extends PreferenceFragment implements
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            boolean enableHwKeys = Settings.System.getInt(getActivity().getContentResolver(),
            ...
            if (hasPowerKey) {
                ...
                if (mCameraDoubleTapPowerGesture != null &&
                    ...
                    int cameraDoubleTapPowerDisabled = Settings.Secure.getInt(
                            getActivity().getContentResolver(), CAMERA_DOUBLE_TAP_POWER_GESTURE_DISABLED, 0);
            ...
            if (hasHomeKey) {
                ...
                int longPressAction = CMSettings.System.getInt(getActivity().getContentResolver(),
                        CMSettings.System.KEY_HOME_LONG_PRESS_ACTION,
                        defaultLongPressAction);
                mHomeLongPressAction = initActionList(KEY_HOME_LONG_PRESS, longPressAction);

                int doubleTapAction = CMSettings.System.getInt(getActivity().getContentResolver(),
            ...
            if (hasMenuKey) {
                ...
                int pressAction = CMSettings.System.getInt(getActivity().getContentResolver(),
            ...
            if (Utils.hasVolumeRocker(getActivity())) {
                ...
                int cursorControlAction = Settings.System.getInt(getActivity().getContentResolver(),
                        Settings.System.VOLUME_KEY_CURSOR_CONTROL, 0);
                mVolumeKeyCursorControl = initActionList(KEY_VOLUME_KEY_CURSOR_CONTROL,
                        cursorControlAction);

                int swapVolumeKeys = CMSettings.System.getInt(getActivity().getContentResolver(),
        ...
        public void onResume() {
            ...
            if (mPowerEndCall != null) {
                final int incallPowerBehavior = Settings.Secure.getInt(getActivity().getContentResolver(),
            ...
            if (mHomeAnswerCall != null) {
                final int incallHomeBehavior = CMSettings.Secure.getInt(getActivity().getContentResolver(),
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            if (preference == mEnableHwKeys) {
                ...
                Settings.Secure.putInt(getActivity().getContentResolver(), CAMERA_DOUBLE_TAP_POWER_GESTURE_DISABLED,
